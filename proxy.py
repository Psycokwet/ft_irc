...
OUT_ADDR = ('global.acn.gr', 6667) # 3333, 6667 la co dinh, irc.2600.net lay trong edit. "Doi thanh localhost khi dung server o local, khi khong dung network tren Hexchat"
BUFF_SIZE = 512
DELIM = "\r\n"
