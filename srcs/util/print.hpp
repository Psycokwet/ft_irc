...
/*
** -------------------------------- POINTER WITH PRINT METHOD CONTAINERS --------------------------------
*/

template <typename T>
std::ostream &print_ptr_method(std::ostream &o, std::map<std::string, T> &container, std::string end = "\n", std::string start = "", std::string sep = "")
{
	for (typename std::map<std::string, T>::const_iterator it = container.begin(); it != container.end(); it++)
	{
		o << start << it->first << sep;
		it->second->print(o) << end;
	}
	return o;
}

template <typename T>
std::ostream &print_ptr_method(std::ostream &o, std::list<T> &container, std::string end = "\n", std::string start = "")
{
	for (typename std::list<T>::const_iterator it = container.begin(); it != container.end(); it++)
	{
		o << start;
...
template <typename T>
std::ostream &print_ptr_method(std::ostream &o, std::vector<T> &container, std::string end = "\n", std::string start = "")
{
	for (typename std::vector<T>::const_iterator it = container.begin(); it != container.end(); it++)
	{
		o << start;
...
template <typename T>
std::ostream &print_ptr_method(std::ostream &o, const std::map<std::string, T> &container, std::string end = "\n", std::string start = "", std::string sep = "")
{
	for (typename std::map<std::string, T>::const_iterator it = container.begin(); it != container.end(); it++)
	{
		o << start << it->first << sep;
...
template <typename T>
std::ostream &print_ptr_method(std::ostream &o, const std::list<T> &container, std::string end = "\n", std::string start = "")
{
	for (typename std::list<T>::const_iterator it = container.begin(); it != container.end(); it++)
	{
		o << start;
...
template <typename T>
std::ostream &print_ptr_method(std::ostream &o, const std::vector<T> &container, std::string end = "\n", std::string start = "")
{
	for (typename std::vector<T>::const_iterator it = container.begin(); it != container.end(); it++)
	{
		o << start;
